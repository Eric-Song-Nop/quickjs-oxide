...
use super::{
    ...
    JsString, NativeFunctionId, NumberFormatKind, NumberParseKind, NumberPredicateKind, ObjectRef,
    OrdinaryPropertyDescriptor, PrimitiveKind, PropertyFlags, PropertyKey, Runtime, RuntimeError,
    SymbolRegistryKind, Value, WellKnownSymbol,
};

impl Runtime {
    pub(super) fn initialize_function_constructor(
        &self,
        realm: ContextId,
    ...
    pub(super) fn initialize_number_intrinsic(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
    ...
    pub(super) fn initialize_boolean_intrinsic(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
    ...
    pub(super) fn initialize_string_conversion_core(
        &self,
        realm: ContextId,
    ...
    pub(super) fn initialize_symbol_intrinsic(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
    ...
    pub(super) fn initialize_bigint_intrinsic(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
    ...
    pub(super) fn initialize_global_functions_prefix(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
        global_object: &ObjectRef,
    ...
    pub(super) fn initialize_global_primitive_constants(
        &self,
        global_object: &ObjectRef,
    ) -> Result<(), RuntimeError> {
    ...
    pub(super) fn initialize_global_to_string_tag(
        &self,
        global_object: &ObjectRef,
    ) -> Result<(), RuntimeError> {
    ...
    pub(super) fn initialize_global_this(
        &self,
        global_object: &ObjectRef,
    ) -> Result<(), RuntimeError> {
    ...
    pub(super) fn initialize_function_restricted_properties(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
    ) -> Result<(), RuntimeError> {
    ...
    pub(super) fn initialize_function_prototype_methods(
        &self,
        realm: ContextId,
        function_prototype: &ObjectRef,
    ) -> Result<(), RuntimeError> {
    ...
    pub(super) fn define_native_builtin_getter(
        &self,
        function_prototype: &ObjectRef,
        realm: ContextId,
    ...
    pub(super) fn define_native_builtin_getter_on(
        &self,
        object: &ObjectRef,
        function_prototype: &ObjectRef,
        realm: ContextId,
    ...
    pub(super) fn define_constructor_relationship(
        &self,

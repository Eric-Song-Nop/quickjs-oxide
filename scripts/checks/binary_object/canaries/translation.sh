expect_rejected translate-extra-module function-translate-module-set \
    crates/engine/src/runtime/binary_object/function_translate/escape.rs 'fn escape() {}'
expect_full_rewrite_table < "$boundary_dir/canaries/translate_canaries.txt"
expect_full_rewrite_rejected translate-ready-remap \
    function-translate-semantic-dispatch crates/engine/src/runtime/binary_object/function_translate/mod.rs \
...
expect_full_rewrite_rejected stage3b-apply-error-classification \
    ordinary-leaf-apply-admission crates/engine/src/runtime/binary_object/ordinary_leaf.rs \
...
expect_full_rewrite_rejected stage3b-apply-stack-effect \
    stage3b-apply-stack crates/core/src/bytecode.rs \
...
expect_full_rewrite_rejected stage3b-nullish-apply-bypass \
    stage3b-apply-order crates/engine/src/runtime/vm_host.rs \
...
expect_full_rewrite_rejected stage3b-raw-new-target-collapse \
    stage3b-raw-construction crates/engine/src/runtime.rs \
...
expect_full_rewrite_rejected stage3b-constructor-callable-narrowing \
    stage3b-constructor-capability crates/engine/src/runtime.rs \
...
expect_full_rewrite_rejected stage3b-function-realm-fallback \
    stage3b-constructor-prototype crates/engine/src/runtime.rs \
...
expect_full_rewrite_rejected stage3b-native-prototype-helper-bypass \
    stage3b-native-prototype-family crates/engine/src/runtime/intrinsics/array_buffer.rs \
...
expect_full_rewrite_rejected stage3b-proxy-call-layer-capability \
    stage3b-proxy-call-order crates/engine/src/runtime/internal_methods.rs \
...
expect_full_rewrite_rejected stage3b-proxy-construct-callable-narrowing \
    stage3b-proxy-construct-order crates/engine/src/runtime/internal_methods.rs \
...
expect_full_rewrite_rejected stage3b-public-raw-construction-leak \
    stage3b-public-construction crates/engine/src/runtime/context/calls.rs \
...
expect_full_rewrite_rejected stage3b-species-callable-narrowing \
    stage3b-species-constructor crates/engine/src/runtime/intrinsics/promise.rs \
...
expect_full_rewrite_rejected stage3c-tail-terminal-fallthrough \
    stage3c-tail-verifier crates/core/src/bytecode.rs \
...
expect_full_rewrite_rejected stage3c-blocker-mapping-swap \
    ...
    crates/engine/src/runtime/binary_object/function_translate/capability.rs \
...
expect_full_rewrite_rejected stage3c-call-arguments-shadow \
    stage3c-tail-vm crates/engine/src/vm.rs \
...
expect_full_rewrite_rejected stage3c-execute-alias-return-bypass \
    stage3c-tail-completion crates/engine/src/vm.rs \
...
expect_full_rewrite_rejected stage3c-required-module-cfg-excluded \
    stage3c-runtime-evidence crates/engine/src/vm.rs \
    $'#[cfg(test)]\nmod tests {' \
    $'#[cfg(any())]\n#[cfg(test)]\nmod tests {'
expect_full_rewrite_rejected stage3c-required-module-inner-cfg-excluded \
    stage3c-runtime-evidence crates/engine/src/runtime/tests.rs \
    'use crate::JsBigInt;' \
    $'#![cfg(any())]\n\nuse crate::JsBigInt;'

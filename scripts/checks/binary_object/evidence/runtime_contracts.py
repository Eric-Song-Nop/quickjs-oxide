...
STAGE3B_ORDERED_CONTRACTS = (('stage3b-validated-construction',
 ...
 ('stage3b-public-construction',
  'crates/engine/src/runtime/intrinsics/reflect.rs',
 ...
 ('stage3b-species-constructor',
  'crates/engine/src/runtime/intrinsics/array_buffer/typed_array/species.rs',
  ...
  ('if !self.is_constructor(&object)? {',
   ...
   'arguments, )? {')),
 ('stage3b-species-constructor',
  'crates/engine/src/runtime/intrinsics/array.rs',
  'array_from_result',
...
NATIVE_OWNED_PROTOTYPE_CONSUMERS = (('crates/engine/src/runtime.rs', 'call_function_constructor'),
 ('crates/engine/src/runtime.rs', 'call_primitive_constructor'),
 ('crates/engine/src/runtime/intrinsics/array_buffer.rs', 'array_buffer_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/error.rs', 'call_error_constructor'),
 ('crates/engine/src/runtime/intrinsics/iterator.rs', 'iterator_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/map.rs', 'map_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/promise.rs', 'promise_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/set.rs', 'set_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/shared_array_buffer.rs', 'shared_array_buffer_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/weak_collection.rs', 'weak_collection_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/weak_ref.rs', 'weak_intrinsic_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/array_buffer/data_view.rs', 'data_view_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/array_buffer/typed_array.rs', 'typed_array_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/date/constructor.rs', 'date_prototype_from_new_target'),
 ('crates/engine/src/runtime/intrinsics/regexp/constructor.rs', 'allocate_regexp_from_new_target'))

CONSTRUCTOR_ONLY_ITEMS = (('stage3b-proxy-construct-order', 'crates/engine/src/runtime/internal_methods.rs', 'construct_proxy'),
 ('stage3b-species-constructor',
  'crates/engine/src/runtime/intrinsics/array_buffer/typed_array/species.rs',
  'typed_array_create_from_constructor_arguments'),
 ('stage3b-species-constructor', 'crates/engine/src/runtime/intrinsics/array.rs', 'array_from_result'),
 ('stage3b-species-constructor', 'crates/engine/src/runtime/intrinsics/array.rs', 'call_array_of'),
 ('stage3b-species-constructor', 'crates/engine/src/runtime/intrinsics/array.rs', 'array_species_create'))

SPECIES_FUNCTIONS = (('crates/engine/src/runtime/intrinsics/array_buffer.rs', 'array_buffer_species_constructor', True),
 ('crates/engine/src/runtime/intrinsics/shared_array_buffer.rs', 'shared_array_buffer_species_constructor', True),
 ('crates/engine/src/runtime/intrinsics/promise.rs', 'promise_species_constructor', True),
 ('crates/engine/src/runtime/intrinsics/regexp/constructor.rs', 'regexp_species_constructor', False))
...
STAGE3C_TEST_MODULE_CONTRACTS = (('crates/engine/src/runtime.rs', ';'),
...
STAGE3C_REQUIRED_TEST_SOURCES = {'crates/core/src/bytecode.rs',
 'crates/engine/src/runtime/binary_object/function_translate/capability.rs',
 'crates/engine/src/runtime/binary_object/function_translate/mod.rs',
 'crates/engine/src/runtime/binary_object/ordinary_leaf.rs',
 'crates/engine/src/runtime/binary_object_publish.rs',
...
STAGE3C_TEST_CONTRACTS = (('crates/engine/src/runtime/binary_object/function_translate/capability.rs',
...
STAGE3C_TEST_BODY_HASHES = {('crates/engine/src/runtime/binary_object/function_translate/capability.rs', 'registry_locks_the_current_physical_cohorts'): '1c74d3733c3b55d08359e7c3b9a9f76babb0f59f841c4306311a054dba0f1b00',
 ('crates/engine/src/runtime/binary_object/function_translate/capability.rs', 'ordinary_invocation_addition_is_the_exact_reviewed_six_row_set'): '0bd25bc945bde404ea911c720491e06a0d58c7257683347372b6c74843d3afc2',
 ...
 ('crates/engine/src/runtime/binary_object/function_translate/mod.rs', 'tail_invocation_lowering_preserves_the_npop_operand_and_kind'): 'f9a36b2d07545f80276edce3e1e7f3e1baaa56fcdfd82996a857be1958acccd2',
 ('crates/engine/src/runtime/binary_object/ordinary_leaf.rs', 'tail_invocation_operands_reach_the_ordinary_dto_unchanged'): 'fd78ceeb26a50bc988ebb4fdece4f4417b89abd31bbfe0edae6480899e8c1ecc',
 ('crates/engine/src/runtime/binary_object_publish.rs', 'ordinary_tail_invocation_publishes_one_for_one_with_the_unchanged_operand'): '7277c89d2d824c8bfe59cecc5ed5fdbf4e68f0368b719794d3072df7782bc94e',
 ('crates/core/src/bytecode.rs', 'verifier_models_tail_invocations_as_terminal_zero_result_operations'): 'c9e3ab6c07492a5e74e91c689b8f70ef324b74ffce9321e92460fc356fe2af07',
 ('crates/engine/src/vm.rs', 'tail_invocations_complete_the_frame_with_exact_call_operands'): '08a72d3c502b9610b9efa10dcdca4bbcfec90d7ffcd76ded373e97f8e8982dac',
 ('crates/engine/src/vm.rs', 'tail_invocation_throws_use_the_activation_backtrace_and_catch_path'): 'b04b8f4116f8988c79c8ed41f6825f996fd15225fd871a6d44708d7e9c344fae',
 ('crates/engine/src/runtime/tests.rs', 'trusted_quickjs_ordinary_tail_invocations_use_exact_bc5_wires_and_semantics'): '4b972572d236f13acf54b98365cd4c8ad52bd86e5a9dc97cbb67b727a8540562',
 ('crates/engine/src/runtime/tests.rs', 'trusted_quickjs_ordinary_tail_invocation_failures_are_recoverable'): '0640226781baa7b22b4a68b2c1d0929ee1c60e09c347c1ebd9f23ed21bfd6235',
 ('crates/engine/src/runtime/tests.rs', 'trusted_quickjs_ordinary_tail_verification_rolls_back_heap_and_atoms'): 'e089f00738beddf2de2926d27f59850eb34b4a806184177deb9922228a0cc767',
 ('crates/engine/src/runtime/tests.rs', 'published_tail_call_uses_backtrace_and_current_activation_catch_semantics'): '46a75e60a1f007a7b626bc0579aeb7435911a47199bf0accc0a2c5dfa4e7cd06'}

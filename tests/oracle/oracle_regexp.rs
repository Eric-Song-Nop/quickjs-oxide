...
#[path = "regexp/oracle_regexp_backreferences.rs"]
mod oracle_regexp_backreferences;
#[path = "regexp/oracle_regexp_compile.rs"]
mod oracle_regexp_compile;
#[path = "regexp/oracle_regexp_dotall.rs"]
mod oracle_regexp_dotall;
#[path = "regexp/oracle_regexp_engine.rs"]
mod oracle_regexp_engine;
#[path = "regexp/oracle_regexp_intrinsic.rs"]
mod oracle_regexp_intrinsic;
#[path = "regexp/oracle_regexp_lookahead.rs"]
mod oracle_regexp_lookahead;
#[path = "regexp/oracle_regexp_lookbehind.rs"]
mod oracle_regexp_lookbehind;
#[path = "regexp/oracle_regexp_match_all.rs"]
mod oracle_regexp_match_all;
#[path = "regexp/oracle_regexp_match_indices.rs"]
mod oracle_regexp_match_indices;
#[path = "regexp/oracle_regexp_modifiers.rs"]
mod oracle_regexp_modifiers;
#[path = "regexp/oracle_regexp_named_groups.rs"]
mod oracle_regexp_named_groups;
#[path = "regexp/oracle_regexp_replace.rs"]
mod oracle_regexp_replace;
#[path = "regexp/oracle_regexp_split.rs"]
mod oracle_regexp_split;
#[path = "regexp/oracle_regexp_unicode_properties.rs"]
mod oracle_regexp_unicode_properties;
#[path = "regexp/oracle_regexp_v_character_class_escapes.rs"]

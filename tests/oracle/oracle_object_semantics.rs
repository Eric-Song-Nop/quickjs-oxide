...
#[path = "object/oracle_object_accessors.rs"]
mod oracle_object_accessors;
#[path = "object/oracle_object_assign.rs"]
mod oracle_object_assign;
#[path = "object/oracle_object_assignment.rs"]
mod oracle_object_assignment;
#[path = "object/oracle_object_bindings.rs"]
mod oracle_object_bindings;
#[path = "object/oracle_object_descriptors.rs"]
mod oracle_object_descriptors;
#[path = "object/oracle_object_enumeration.rs"]
mod oracle_object_enumeration;
#[path = "object/oracle_object_extensibility.rs"]
mod oracle_object_extensibility;
#[path = "object/oracle_object_from_entries.rs"]
mod oracle_object_from_entries;
#[path = "object/oracle_object_group_by.rs"]
mod oracle_object_group_by;
#[path = "object/oracle_object_has_own.rs"]
mod oracle_object_has_own;
#[path = "object/oracle_object_integrity.rs"]
mod oracle_object_integrity;
#[path = "object/oracle_object_intrinsic.rs"]
mod oracle_object_intrinsic;
#[path = "object/oracle_object_is.rs"]
mod oracle_object_is;
#[path = "object/oracle_object_literals.rs"]
mod oracle_object_literals;
#[path = "object/oracle_object_methods.rs"]
mod oracle_object_methods;
#[path = "object/oracle_object_rest.rs"]
mod oracle_object_rest;
#[path = "object/oracle_object_super.rs"]
mod oracle_object_super;
#[path = "object/oracle_object_super_arrow.rs"]
mod oracle_object_super_arrow;
#[path = "object/oracle_object_super_eval.rs"]
mod oracle_object_super_eval;
#[path = "object/oracle_objects.rs"]
mod oracle_objects;

...
#[path = "program_declarations/oracle_program_functions.rs"]
mod oracle_program_functions;
#[path = "program_declarations/oracle_program_lexicals.rs"]
mod oracle_program_lexicals;
#[path = "program_declarations/oracle_program_vars.rs"]

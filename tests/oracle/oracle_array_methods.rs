...
#[path = "array/oracle_array_concat.rs"]
mod oracle_array_concat;
#[path = "array/oracle_array_copy_within.rs"]
mod oracle_array_copy_within;
#[path = "array/oracle_array_fill.rs"]
mod oracle_array_fill;
#[path = "array/oracle_array_find.rs"]
mod oracle_array_find;
#[path = "array/oracle_array_flatten.rs"]
mod oracle_array_flatten;
#[path = "array/oracle_array_iteration.rs"]
mod oracle_array_iteration;
#[path = "array/oracle_array_map_filter.rs"]
mod oracle_array_map_filter;
#[path = "array/oracle_array_mutators.rs"]
mod oracle_array_mutators;
#[path = "array/oracle_array_reduce.rs"]
mod oracle_array_reduce;
#[path = "array/oracle_array_reverse.rs"]
mod oracle_array_reverse;
#[path = "array/oracle_array_slice_splice.rs"]
mod oracle_array_slice_splice;
#[path = "array/oracle_array_sort.rs"]
mod oracle_array_sort;
#[path = "array/oracle_array_stringification.rs"]
mod oracle_array_stringification;
#[path = "array/oracle_array_with.rs"]

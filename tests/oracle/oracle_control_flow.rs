...
#[path = "control_flow/oracle_annex_b_statements.rs"]
mod oracle_annex_b_statements;
#[path = "control_flow/oracle_catch_destructuring.rs"]
mod oracle_catch_destructuring;
#[path = "control_flow/oracle_for_in.rs"]
mod oracle_for_in;
#[path = "control_flow/oracle_for_lexicals.rs"]
mod oracle_for_lexicals;
#[path = "control_flow/oracle_for_of.rs"]
mod oracle_for_of;
#[path = "control_flow/oracle_statement_control_flow.rs"]
mod oracle_statement_control_flow;
#[path = "control_flow/oracle_switch_control_flow.rs"]
mod oracle_switch_control_flow;
#[path = "control_flow/oracle_try_catch_finally.rs"]
mod oracle_try_catch_finally;
#[path = "control_flow/oracle_with.rs"]
mod oracle_with;

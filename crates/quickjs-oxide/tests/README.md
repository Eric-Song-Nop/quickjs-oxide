...
- `crates/core/src`, `crates/compiler/src`, and `crates/engine/src`: unit tests
  beside the implementation they inspect.
- `crates/quickjs-oxide/tests`: public Rust embedding integration tests.
...
- `tools/test262/src`: runner unit tests; active generated data remains under
  `dev-support/test262`.

...
| `host.rs` | Embedding contract; native implementation lives in the host crate |
...
Engine handles retain their ownership and pending-exception behavior.
Default runtime construction belongs to the Rust embedding crate. It does not introduce a new binding abstraction

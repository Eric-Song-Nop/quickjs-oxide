...
fn unlinked_closure_name<'a>(
    ...
    match descriptor.name {
        ...
        ClosureVariableName::Constant(index) => {
            ...
            let Some(quickjs_oxide_core::value::PrimitiveValue::String(name)) = name else {
...
fn verify_unlinked_string_constant(
    ...
    if !matches!(
        function
            ...
            .get(index)
            .and_then(UnlinkedConstant::as_primitive),
        Some(quickjs_oxide_core::value::PrimitiveValue::String(_))
    ) {
    ...
    loop {
        ...
        if let Some(constant) = next {
            ...
            match (primitive, atom_string, child) {
                (Some(quickjs_oxide_core::value::PrimitiveValue::String(value)), true, None) => {
                    frames
                        .last_mut()
                        .expect("flatten frame remains present")
                        .constants
...
mod tests {
    ...
    fn named_function_initializer_cannot_claim_default_name_inference() {
        ...
        let name = module
            ...
            .position(|constant| {
                constant.as_primitive()
                    == Some(&quickjs_oxide_core::PrimitiveValue::String(

...
impl UnlinkedConstant {
    ...
    #[must_use]
    pub fn atom_string(value: crate::value::JsString) -> Self {
...
impl UnlinkedVariableDefinition {
    ...
    #[must_use]
    pub const fn ordinary(name: Option<crate::value::JsString>) -> Self {
        Self {
            name,
            is_lexical: false,
            is_const: false,
    ...
    pub const fn lexical(name: Option<crate::value::JsString>, is_const: bool) -> Self {
        Self {
            name,
            is_lexical: true,
            is_const,
...
pub struct UnlinkedFunctionDebug {
    pub filename: crate::value::JsString,
...
pub struct UnlinkedFunctionParts {
    ...
    pub func_name: Option<crate::value::JsString>,
...
impl UnlinkedFunction {
    ...
    pub fn new_with_closure_variables(
        code: Vec<Instruction>,
        constants: Vec<UnlinkedConstant>,
        metadata: FunctionMetadata,
        closure_variables: Vec<ClosureVariable>,
    ...
    #[must_use]
    pub fn with_name(mut self, name: Option<crate::value::JsString>) -> Self {
    ...
    /// flag combinations.
    #[must_use]
    pub fn with_variable_definitions(
        mut self,
        argument_definitions: Vec<UnlinkedVariableDefinition>,
    ...
    #[must_use]
    pub fn func_name(&self) -> Option<&crate::value::JsString> {
